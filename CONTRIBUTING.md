# Contributing to the **Longtail** repository
...
- Check the **Longtail** [issues](https://github.com/duckduckgo/zeroclickinfo-longtail/issues) to see if an issue already exists for the given bug or suggestion
